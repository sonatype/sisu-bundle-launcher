...
/**
 * Jetty bundle resolver.
 *
 * @since 1.4
 */
@Named
public class JettyBundleResolver
    extends MavenBridgedBundleResolver
{
     ...
     */
    public static final String BUNDLE_COORDINATES = "jetty.bundle.coordinates";
     ...
     */
    @Inject
    public JettyBundleResolver( final @Nullable @Named( "${" + BUNDLE_COORDINATES + "}" ) String bundleCoordinates,
