 ...
 * @since 1.0
 */
public class MonitoredBooter
{

    public static final String LAUNCHER = MonitoredBooter.class.getName() + ".launcher";

    public static final String PORT = MonitoredBooter.class.getName() + ".port";
        ...
        throws Exception
    {
        ...
        Class<?> launcherClass = MonitoredBooter.class.getClassLoader().loadClass( launcher );
        Method main = launcherClass.getMethod( "main", args.getClass() );

        // Setup command monitor if configured
        String commandMonitorPort = System.getProperty( PORT );
